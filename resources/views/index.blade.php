...
<body>
    ...
    <main>
        ...
        <div class="description">
            <div class="info">
                <p>パンは、小麦粉を主原料とし、水や塩、砂糖、イーストなどを加えて発酵させ、焼き上げる食品です。基本的な食材であるため、世界中で広く食べられています。種類も豊富で、食パン、フランスパン、バゲット、クロワッサン、デニッシュ、ベーグル、ライ麦パン、ナンなどがあります。用途も多様で、朝食、昼食、夕食、スナックとして利用されます。また、サンドイッチやトースト、ハンバーガーバンズとしても人気です。</p>
