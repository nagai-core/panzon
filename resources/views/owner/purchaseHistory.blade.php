                ...
                @else
                    <ul class="list-unstyled">
                        @php
                            $id = 1;
                        @endphp
                        @foreach ($purchaseHistories->sortByDesc('id') as $history)
                            <li class="mb-4">
